...
return {
  ...
  custom_highlights = {
    ["@property"] = { fg = c.main.yellow },
    ["@variable.member"] = { fg = c.main.yellow },
    NvimTreeFolderName = { fg = c.editor.accent, bold = true },
    NvimTreeFolderIcon = { fg = c.editor.accent, bold = true },
    NvimTreeIndentMarker = { fg = c.editor.accent, bold = true },
  },
}
