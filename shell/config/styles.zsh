# [[ ! -f "$DOTFILES_PATH/shell/config/themes/pure.zsh" ]] || source "$DOTFILES_PATH/shell/config/themes/pure.zsh"
...
[[ ! -f "$DOTFILES_PATH/shell/config/themes/p9k.zsh" ]] || source "$DOTFILES_PATH/shell/config/themes/p9k.zsh"
